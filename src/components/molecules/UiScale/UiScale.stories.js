...
export default {
  ...
  parameters: {
    cssProperties: {
      ...
      '--scale-mobile-controls-margin-block':
        'var(--scale-mobile-controls-margin-block-start, var(--space-32)) var(--scale-mobile-controls-margin-block-end, 0)',
      '--scale-mobile-controls-margin-inline':
        'var(--scale-mobile-controls-margin-inline-start, 0) var(--scale-mobile-controls-margin-inline-end, 0)',
      '--scale-option-border-block-width':
        'var(--scale-option-border-block-start-width, 0) var(--scale-option-border-block-end-width, 0)',
      '--scale-option-border-inline-width':
        'var(--scale-option-border-inline-start-width, 0) var(--scale-option-border-inline-end-width, 0)',
      ...
      '--scale-label-padding-block':
        'var(--scale-label-padding-block-start, var(--space-8)) var(--scale-label-padding-block-end, var(--space-8))',
      '--scale-label-padding-inline':
        'var(--scale-label-padding-inline-start, 0) var(--scale-label-padding-inline-end, 0)',
      ...
      '--scale-description-margin-block':
        'var(--scale-description-margin-block-start, var(--space-16)) var(--scale-description-margin-block-end, 0)',
      '--scale-description-margin-inline':
        'var(--scale-description-margin-inline-start, 0) var(--scale-description-margin-inline-end, 0)',

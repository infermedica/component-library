...
<Canvas>
  ...
  >
    {((args, { argTypes }) => ({
      ...
      >
        <UiDropdownItem value="enabled-a">Enabled A</UiDropdownItem>
        <UiDropdownItem value="enabled-b">Enabled B</UiDropdownItem>
        <UiDropdownItem value="enabled-c">Enabled C</UiDropdownItem>
      </UiDropdown>`,
    })).bind({})}
  </Story>
</Canvas>

...
export default {
  ...
  parameters: {
    cssProperties: {
      ...
      '--range-padding-block':
        'var(--range-padding-block-start, calc(var(--_range-thumb-size) + 0.5rem)) var(--range-padding-block-end, 0)',
      '--range-padding-inline':
        'var(--range-padding-inline-start, 0) var(--range-padding-inline-end, 0)',
      '--range-tablet-input-margin-block':
        'var(--range-tablet-input-margin-block-start, 0) var(--range-tablet-input-margin-block-end, 0)',
      '--range-tablet-input-margin-inline':
        'var(--range-tablet-input-margin-inline-start, 0) var(--range-tablet-input-margin-inline-end, 0)',
      ...
      '--range-track-margin-block':
        'var(--range-track-margin-block-start, 0) var(--range-track-margin-block-end, 0)',
      '--range-track-margin-inline':
        'var(--range-track-margin-inline-start, 0) var(--range-track-margin-inline-end, 0)',
      '--range-thumb-border-block':
        'var(--range-thumb-border-block-start, 0) var(--range-thumb-border-block-end, 0)',
      '--range-thumb-border-inline':
        'var(--range-thumb-border-inline-start, 0) var(--range-thumb-border-inline-end, 0)',

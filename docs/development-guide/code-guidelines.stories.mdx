...
# Code Guidelines
The Symptom Checker Uikit development team has rules to keep the code clean and easy to understand - for all team members.
...
<PageOutline>
  ...
  <PageOutlineList>
    <li>
      <a href="#components-rules">Components rules</a>
      <PageOutlineListNested>
        <li>
         <a href="#naming">Naming</a>
        </li>
        <li>
          <a href="#files-structure">File structure</a>
        </li>
        <li>
    ...
    <li>
      ...
      <PageOutlineListNested>
        <li>
          <a href="#naming-rules">Naming</a>
        </li>
      </PageOutlineListNested>
    </li>
    <li>
      <a href="#template-rules">Template rules</a>
    </li>
    <li>
      <a href="#deprecation-guidelines">Deprecation guidelines</a>
    </li>
    <li>
      <a href="#unit-tests">Unit tests</a>
    </li>
    <li>
      <a href="#stories-for-storybook">Stories for Storybook</a>
    </li>
  </PageOutlineList>
</PageOutline>
...
- `*.spec.js` - Jest test file. By default you can find `render test` on it. Read more about [Vue Test Utils](https://vue-test-utils.vuejs.org/) and [Jest](https://jestjs.io/).
...
```
More details you can find in [CSS Customization](/docs/getting-started-development-guide-css-customization--page) section.
...
// END
```
* Add console.warn only in development mode
```js
if(process.env.NODE_ENV === 'development') {
    console.warn('[@symptom-checker/ui-kit warn]: <deprecated> will be removed in <version>. Please use <new> instead.');
}
```
Here is a example for slot deprecation:
```js
if (process.env.NODE_ENV === 'development') {

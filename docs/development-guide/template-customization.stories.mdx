...
Generally to name this props we used `<name-of-component-without-prefix>Attrs` e.g. `buttonAttrs` but in some cases we need to use `<name-of-component-without-prefix><function>Attrs` e.g. `buttonIncrementAttrs` or `closeButtonAttrs`

...
<Meta title="Contribute/Branching"/>
...
<PageOutline>
  ...
  <PageOutlineList>
    <li>
      <a href="#gitflow-workflow">Gitflow Workflow</a>
      <PageOutlineListNested>
        <li>
          <a href="#daily-development">Daily Development</a>
        </li>
        <li>
...
Symptom Checker UI Kit uses a [Conventional Commits](https://conventionalcommits.org/), i.e. a commit message that follows a specific format.

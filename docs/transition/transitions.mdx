...
These components use our transitions:
- [Modal](?path=/docs/organisms-modal--docs)
- [SidePanel](?path=/docs/organisms-sidepanel--docs)
- [Popover as Bottom Panel On Mobile](?path=/story/molecules-popover--as-bottom-panel-on-mobile)
...
<Canvas of={stories.SlideFromLeft} />
